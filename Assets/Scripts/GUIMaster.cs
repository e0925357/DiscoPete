...
public class GUIMaster : MonoBehaviour {
    ...
    private GUIText m_tOverlayLine1;
    private GUIText m_tOverlayLine2;
	...
	void Start () {
        ...
        if (line1GO != null)
        {
            m_tOverlayLine1 = line1GO.GetComponent<GUIText>();
        ...
        if (line2GO != null)
        {
            m_tOverlayLine2 = line2GO.GetComponent<GUIText>();
